  ...
  const TooltipEngine = {
   ...
   hide: () => {
    ...
    handleTreasure: (step) => {
      ...
      document.getElementById(`treasure-2-${step}`).style.display = 'none';
    ...
    init: async () => { 
     ...
     // 1. Καθαρισμός HTML
      ...
      document.addEventListener('click', (e) => {
        ...
        if (STATE.isDraggingMap) return; // Προστασία από ghost-clicks
        ...
        // Δημιουργία κοινής κλάσης εξαίρεσης ΚΑΙ για Banners ΚΑΙ για Treasures
         ...
         mapAreaPanzoom.addEventListener('pointerup', (e) => {
          ...
          mapAreaPanzoom.addEventListener('panzoomend', () => {
            setTimeout(() => {
              document.querySelectorAll('#map-area-2 .t-banner, #map-area-2 .t-treasure').forEach(el => el.style.pointerEvents = 'auto');
            }, 50);
          });
