...
/* ========================================================================
   💎 SENIOR MASTER GLASSMORPHISM MODAL
   ======================================================================== */

.glass-modal-overlay {
  position: fixed;
  inset: 0; /* Αντικαθιστά τα top:0, left:0, width:100%, height:100% */
  background: rgba(0, 0, 0, 0.5); /* Σκοτείνιασμα φόντου */
  backdrop-filter: blur(5px);
  -webkit-backdrop-filter: blur(5px);
  
  /* Flexbox για ΑΠΟΛΥΤΟ κεντράρισμα παντού, χωρίς padding/margin hacks! */
  display: flex;
  align-items: center; 
  justify-content: center;
...
.glass-modal-box {
  background: rgba(30, 41, 59, 0.85); /* Σκούρο μπλε/γκρι */
  ...
  width: 90%;
  max-width: 400px; /* Δεν θα ξεχειλώσει ποτέ σε PC */
  margin: 0; /* Καθαρίζουμε παλιά margins */
...
/* Η κλάση που θα αντικαταστήσει το inline style στο HTML σου */
.glass-modal-actions {
  display: flex;
  gap: 10px;
  justify-content: center;
