     ...
     // 2. Έξυπνο Event Delegation
      ...
      if (isDesktop && mapAreaPanzoom) {
        ...
        // Δημιουργία κοινής κλάσης εξαίρεσης ΚΑΙ για Banners ΚΑΙ για Treasures
         ...
         /* ΔΙΑΓΡΑΦΗ: Αφαιρέστε ή κάντε σχόλιο (comment out) εντελώς αυτούς 
            τους δύο Event Listeners (panzoomstart & panzoomend). Η προστασία σας 
            μέσω της μεταβλητής (if (STATE.isDraggingMap) return;) είναι η σωστή προσέγγιση. */
